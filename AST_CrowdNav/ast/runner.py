...
#from dsrnn_coupled_simulator import DSRNNCoupledSimulator
        ...
        with tf.Session(config=config) as sess:
            with tf.variable_scope('AST', reuse=tf.AUTO_REUSE):
                ...
                with LocalTFRunner(
                    ...
                    reward_function = DSRNNReward(**reward_args)
                    spaces = DSRNNSpaces(**spaces_args)

                    sim = DSRNNCoupledSimulator(**sim_args)
                    ...
                    if save_expert_trajectory:
                        load_convert_and_save_mcts_expert_trajectory(
                            best_actions_filename='/home/peterdu2/policy_summarization/AST_CrowdNav/ast/results/best_actions.p',
                            expert_trajectory_filename='/home/peterdu2/policy_summarization/AST_CrowdNav/ast/results/expert_trajectories.p',
                            sim=sim,
                            s_0=env_args['s_0'],
                            reward_function=reward_function)
