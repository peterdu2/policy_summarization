...
class Config(object):
    ...
    training.num_env_steps = 30e6  # number of environment steps to train: 10e6 for holonomic, 20e6 for unicycle
    ...
    training.output_dir = 'data/policy_summarization'  # the saving directory for train.py
    training.resume = False  # resume training from an existing checkpoint or not
    training.load_path = 'data/policy_summarization/checkpoints/27776.pt'  # if resume = True, load from the following checkpoint
