...
if __name__ == '__main__':
    render_dir = '/home/peter/policy_summarization/AST_CrowdNav/ast/results/data/ast_dsrnn_5/renders'
    palette_path = '/home/peter/policy_summarization/AST_CrowdNav/ast/palette.png'
    output_dir = '/home/peter/policy_summarization/AST_CrowdNav/ast/results/data/ast_dsrnn_5/renders/gifs'
    ...
    for traj_dir in trajectories:
        ...
        gif_gen_cmd = 'ffmpeg -y -framerate 15 -i ' + image_filenames + ' -i ' + palette_path + ' -lavfi paletteuse ' + output_path
